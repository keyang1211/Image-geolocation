...
class trainwMAEpretrain(pl.LightningModule):
    def __init__(self,modelparams: Namespace,image_size=224,
        ...
        self.encoder, self.regressor = self.__build_model()
    ...
    def __build_encoder(self):
        ...
        new_model =MAEpretrain.MAEpretrainencoder(
    ...
    def on_train_epoch_end(self):
        ...
        self.log("trainingloss_epoch_mean", epoch_mean)
        # free up the memory
...
#             print("---------------------------------------------------")
    ...
    def on_validation_epoch_end(self):
        ...
        self.log("val_loss_epoch", avg_loss.item())
