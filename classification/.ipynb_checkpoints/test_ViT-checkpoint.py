...
from classification import utils_global,trainViT
...
def parse_args():
    ...
    args.add_argument(
        "--checkpoint",
        type=Path,
        default=Path("/work3/s212495/data/models/ViT/240121-0006/ckpts/epoch=17-the_val_loss=5086.83.ckpt"),
...
def main():
    ...
    model = trainViT.ViTregressor.load_from_checkpoint(checkpoint_dir)
