...
from classification import utils_global,MAEpretrain
...
def parse_args():
    ...
    args.add_argument(
        "--checkpoint",
        type=Path,
        default=Path("/work3/s212495/data/models/MAEpretrained/240202-1826/ckpts/epoch=19-val_loss_epoch=928141.25.ckpt"),
...
def main():
    ...
    model = MAEpretrain.MAEpretrain.load_from_checkpoint(checkpoint_dir)
