from classification import trainwMAEprel50
...
def main():
    ...
    # init 
    model = trainwMAEprel50.trainwMAEpretrain(modelparams=Namespace(**model_params))
    ...
    trainer.fit(model,ckpt_path="/work3/s212495/data/models/trwMAEpre/240202-2114/last50ckpts/last.ckpt")
