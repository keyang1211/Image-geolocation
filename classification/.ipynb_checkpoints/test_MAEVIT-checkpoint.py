...
from classification import utils_global,trainwMAEpre
...
def parse_args():
    ...
    args.add_argument(
        "--checkpoint",
        type=Path,
        default=Path("/work3/s212495/data/models/trwMAEpre/240206-1015/ckpts/epoch=21-val_loss_epoch=5029.89.ckpt"),
...
def main():
    ...
    model = trainwMAEpre.trainwMAEpretrain.load_from_checkpoint(checkpoint_dir)
