...
from classification import utils_global,train_resnet_nonlinear
...
def parse_args():
    ...
    args.add_argument(
        "--checkpoint",
        type=Path,
        default=Path("/work3/s212495/data/models/resnetnonlinear/240121-0000/ckpts/epoch=16-the_val_loss=4962.01.ckpt"),
...
def main():
    ...
    model = train_resnet_nonlinear.resnetregressor.load_from_checkpoint(checkpoint_dir)
